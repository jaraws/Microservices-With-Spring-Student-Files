...
8. Run the application.  Open the URL [http://localhost:8001/lab-3-server/default/](http://localhost:8001/lab-3-server/default/).  You should see the JSON result that will actually be used by Spring.  If the server is not working, review the prior steps to find the issue before moving on.
